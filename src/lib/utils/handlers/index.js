...
export const loginFormHandler = async ({
  ...
  if (identifier === 'test001' && password === 'test001') {
    ...
    window.location.href = '/ofms'; // Rediriger vers le tableau de bord /dashboard
  } else if (identifier === 'BOO' && password === 'BOO') {
    localStorage.setItem('fakeAuthToken', 'fakeTokenBOO');
