          ...
          <form onSubmit={handleSubmit}>
            <VStack align="start" spacing={4}>
              ...
              <SimpleGrid columns={3} spacing={4} w="100%">
                ...
                <FormControl
                  isInvalid={errors.dateRencontre && touched.dateRencontre}
                >
                ...
                <FormControl
                  isInvalid={errors.typeRencontre && touched.typeRencontre}
                >
                ...
                <FormControl
                  isInvalid={errors.codeRencontre && touched.codeRencontre}
                >
                ...
                <FormControl
                  isInvalid={errors.codeDirective && touched.codeDirective}
                >
                ...
                <FormControl
                  isInvalid={errors.typeDirectives && touched.typeDirectives}
                >
                ...
                <FormControl
                  isInvalid={errors.directives && touched.directives}
                >
                ...
                <FormControl
                  isInvalid={
                    errors.ministereAssocies && touched.ministereAssocies
                  }
                >
                ...
                <FormControl
                  isInvalid={errors.dateLimite && touched.dateLimite}
                >
                ...
                <FormControl
                  isInvalid={
                    errors.dateLimitePrevue && touched.dateLimitePrevue
                  }
                >
                ...
                {/* Colonne 4 */}
                <FormControl
                  isInvalid={errors.dateDebutReel && touched.dateDebutReel}
                >
                ...
                <FormControl
                  isInvalid={errors.dateFinReelle && touched.dateFinReelle}
                >
...
export const ProjetFormOld = (props) => {
  const router = useRouter();
  const toast = useToast();
            ...
            <VStack align="start">
              ...
              <HStack w={'100%'} spacing={4} mb={2}>
                <FormControl isInvalid={errors.duration && touched.duration}>
                  <FormLabel fontSize={12}>Duréhdhe</FormLabel>
                  <Input
                    type="number"
                    name="duration"
                    onChange={handleChange}
